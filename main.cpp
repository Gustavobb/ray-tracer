...
int main() {
    ...
    hittable_list world;
    auto mat = make_shared<metal>(color(0.2, 0.4, 0.8), 0.0);

    point3 center(0, 0, 0);
    world.add(make_shared<cone>(center, 0.5, .8, mat));
    //world.add(make_shared<sphere>(center, .2, mat));

    // Camera
    point3 lookfrom(10,1,1);
    point3 lookat(0,0,0);
    vec3 vup(0,1,0);
